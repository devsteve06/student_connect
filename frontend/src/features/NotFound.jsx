...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 px-4 text-center">
      ...
      <p className="text-xs font-bold uppercase tracking-widest text-slate-400">Error 404</p>
      <h1 className="mt-2 text-2xl font-extrabold tracking-tight text-slate-900">This page doesn't exist</h1>
